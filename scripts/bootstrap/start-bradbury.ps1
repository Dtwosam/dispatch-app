...
if ($missing.Count -gt 0) {
  throw "Arc server-signer startup requires these environment variables: $($missing -join ', ')"
}
...
$envDefaults = @{
  ...
  ARC_CHAIN_MODE = "server_signer_proxy"
...
Write-Host "Started Arc server-signer local stack:"
